...
---
 ...
 PC机及其操作系统的一个特点就是允许用户按照自己的要求对计算机系统的硬件和软件进行各种各样的配置。早期的图形操作系统，如Win3.x中，对软硬件工作环境的配置是通过对扩展名为.ini的文件进行修改来完成的，但INI文件管理起来很不方便，因为每种设备或应用程序都得有自己的INI文件，并且在网络上难以实现[远程访问](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/3/09/282.shtml)。
 ...
 3.管理人员和用户通过注册表可以在网络上检查系统的配置和设置，使得[远程管理](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/4/08/947.shtml)得以实现。
 ...
 hkey_dyn_data 包含现在计算机[内存](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/02/131.shtml)中保存的系统信息。
 ...
 Hkey_users/.Default/so../microsoft/windows/currentVersion/explorer/ecent[Doc](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/6/11/2495.shtml)s 保存最近使用的十五个文档的快捷方式(删除掉可解决文档名称重复的毛病)，清除文档菜单时将被清空。
 ...
 HKEY_CURRENT_USER/Control Panel/Desktop 新建串值名MenuShowDelay=0 可使“开始”菜单中子菜单的弹出[速度](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/09/217.shtml)提高。新建串值名MinAnimate，值为1启动动画效果开关窗口，值为0取消动画效果。
 ...
 注意：在显示备份的注册表文件时，[压缩](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/10/05/1209.shtml)备份的文件以.CAB文件列出，CAB文件的后面单词是Started或者是NotStarted，Started表示这个文件能够成功启动Windows，是一个完好的备份文件，NotStarted表示文件没有被用来启动Windows，因此还不能够知道是否是一个完好备份。
 ...
 1.加快开机及关机[速度](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/09/217.shtml)
 ...
 3.清除[内存](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/02/131.shtml)内被不使用的DLL文件
 ...
 和Windows 2000一样，XP在浏览局域网时也存在烦人的延迟问题，但介绍这个问题的资料却很难找到。如果你浏览一台Win 9x的机器，例如，在网上邻居的地址栏输入“/computername”，XP的机器会在它正在连接的机器上检查“任务计划”。这种搜索过程可能造成多达30秒的延迟。如果你直接打开某个共享资源，例如在网上邻居的地址栏输入“/computernameshare”，就不会有这个延迟过程。要想避免XP搜索“任务计划”的操作，提高浏览网络的[速度](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/09/217.shtml)，你可以删除HKEY_LOCAL_MACHINESOFTWAREMicrosoftWindowsCurrentVersionExplorerRemoteComputerNameSpace{D6277990-4C6A-11CF-8D87-00AA0060F5BF}子键。该键的类型是REG_SZ

 7.屏蔽系统中的热键 

 点击“开始”→“运行”，输入Regedit，打开注册表编辑器。然后依次打开到HKEY_CURRENT_USER/Software/Microsoft/Windows/CurrentVersion/Policies/Explorer，新建一个双[字节](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/07/748.shtml)值，键名为“NoWindows Keys”，键值为“1”，这样就可以禁止用户利用系统热键来执行一些禁用的命令。如果要恢复，只要将键值设为0或是将此键删除即可
 ...
 9.让IE支持多[线程](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/9/01/1857.shtml)下载

 一般情况下，大家都使用[多线程](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/07/442.shtml)下载软件如Flashget等下载文件，其实IE也可以支持多线程下载的，只是微软将这个功能给藏了起来。我们把它给挖出来就可以使用了。打开注册表编辑器，在注册表HKEY_CURRENT_USER/Software/Microsoft/Windows/CurrentVersion/Internet Settings下新建双[字节](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/07/748.shtml)值项“MaxConnectionsPerServer”，它决定了最大同步下载的连线数目，一般设定为5～8个连线数目比较好。另外，对于HTTP 1.0[服务器](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/02/1684.shtml)，可以加入名为“MaxConnectionsPer1_0Server”的双字节值项，它也是用来设置最大同步下载的数目，也可以设定为5～8。
 ...
 当我们在系统中安装了虚拟光驱后，“我的电脑”中就会多出一个光盘图标，即便日后你不再使用虚拟光驱，虚拟光驱图标还会继续保留，实在没有必要。我们动手来删除这个多余的虚拟光驱图标：单击“开始→运行”，输入“regedit”，按下“确定”键后打开注册表编辑器，依次展开HKEY_LOCAL_MACHINE/Enum/[SCSI](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/02/1527.shtml)分支，在SCSI子键下通常有两个子键，它们分别对应着虚拟光驱和物理光驱，把SCSI下的子键全部删除，重新启动电脑后虚拟光驱图标就会被删除。
 ...
 /Explorer/[Doc](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/6/11/2495.shtml)-FindSpecMRU分支，将右侧窗口中的相关键值删除即可。
 ...
 2、为一些非[SCSI](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/02/1527.shtml)[接口](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/3/22/372.shtml)光驱进行手工配置
 ...
 A、首先必须将你手中的对应的非SCSI接口的CD-[ROM](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/3/03/843.shtml)驱动程序从安装盘拷贝到WINNT/SYSTEM32/DRIV ERS目录下。
 ...
 6、加速文件管理系统[缓存](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/3/22/370.shtml)

 大家知道计算机的[速度](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/09/217.shtml)有很大一部分与[内存](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/02/131.shtml)相关，如果内存容量大一点，计算机运行速度就会相应快一点。但是假设在内存一定的情况下，如何来提高计算机的运行速度呢？这就是我们下面通过注册表设置要实现的内容，具体步骤如下：
 ...
 [RAM](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/3/03/840.shtml) (MB) IoPageLockLimit 32 4096000 64 8192000 128 16384000 256+ 65536000
 ...
 9、登录局域网[超时](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/16/06/1347.shtml)自动断开
 ...
 B、在编辑器右边的列表中用鼠标选择“AUTOD[ISC](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/4/01/1653.shtml)ONNECT”键值。

 C、接着用鼠标双击“AUTODI[SCO](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/4/05/921.shtml)NNECT”键值，编辑器就会弹出一个名为“字符串编辑器”的对话框，在该对话框的文本栏中输入数值“1”，其中0代表取消自动断开功能，1代表使用自动断开功能。

 D、退出后重新登录网络，上述功能就会生效。

 10、改变[远程访问](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/3/09/282.shtml)服务的缺省端口传输[速度](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/09/217.shtml)

 Windows NT远程访问服务为每个[RAS](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/3/03/841.shtml)串行端口设置两种BPS速度：[载波](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/07/2521.shtml)BPS与联接BPS速度，前者是指两个Modem通过电话线传输数据的速度，后者则指Modem与主机串口间的数据传输速度；当远程服务被启动时，计算机首先将其联接BPS速度值存放于/System Root//System32/RAS/Modem.INF文件中，以MAXC ARRIERBPS参数形式存放，然后将该值保存在RASSERIAL.INF文件中，以后每次进行传输时对串口作初始化，只需改变SERIAL.INI文件，即可改变串口传输速度，具体操作方法如下：
 ...
 E、从[服务器](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/02/1684.shtml)菜单中选择“Stop Remote Access Service”，再选择“Start Remote Access Service”，上述设置就会生效。 自动检测慢网登陆
 ...
 12、加快网络传输[速度](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/09/217.shtml)

 对于拨号用户来说，时间就是金钱，怎样才能节约时间，节省金钱呢？回答是提高网络传输速度。那又如何提高网络传输速度呢？大家知道，网络速度主要是受网络[带宽](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/07/449.shtml)限制的。增加带宽不是拨号用户所能做到的，他们唯一能做的就是把[调制](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/06/2519.shtml)解调器的传输速度能够再提高一点。其实拨号用户还可以从计算机本身运行速度出发，尽量能挖掘计算机在网络加速方面最大的潜能。下面我们就通过一些设置来尽量加快网络传输速度，具体设置如下：
 ...
 D、选择指定的键值并双击，当出现“字符串编辑器”对话框时，在“字符串”文本框中输入“576”，576代表最大传输[单元](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/13/06/512.shtml)值。

 E、接着在编辑器菜单栏中依次选择“编辑”→“新增”→“字符串值”，右边列表窗口就会多出一个新字符串，把它 命名为“MaxSSS”，再双按这个字符串值并把它设定为“536”。

 F、重新返回到编辑器的主操作界面，并依次展开如下键值：[HKEY_LOCAL_MACHINE/System/Current Control Set/Services/VxD/MS[TCP](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/11/02/7.shtml)]。
 ...
 15、取消系统检测串口，提高NT系统启动[速度](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/09/217.shtml)
 ...
 **为什么系统越来越慢？**
 ...
 为了保障安全，笔者在机房中每台电脑上都安装了KV2004杀毒软件。经过一段时间的使用，确实起到了防杀病毒的作用。但没过多久，老师和学生都纷纷向我抱怨，反映机器的运行[速度](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/09/217.shtml)越来越慢，就连运行一些常用软件如[Word](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/10/01/1911.shtml)、Excel都变得极其缓慢，有时需要等半分钟以上。

 笔者考虑故障可能是因为长时间没有进行磁盘碎片整理造成的，于是对每台计算机进行了碎片整理，问题并没有解决。以前未安装KV2004杀毒软件时，从没出现过这样的问题，看来故障就是由杀毒软件引起的。在打开Word、Excel等应用程序时，KV2004杀毒软件都要进行[扫描](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/8/04/2499.shtml)，扫描完成后要运行的软件才能被完全打开。但是，也不能为了提高速度就卸载杀毒软件啊！这时，笔者突然想到了“任务管理器”。Windows 2000/XP中的“任务管理器”是一个很实用的小工具，它可以结束没有响应的[进程](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/9/01/1854.shtml)、查询[CPU](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/3/02/1805.shtml)和[内存](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/1/02/131.shtml)的使用情况，还有一个功能就是设置任务的优先级。我们机房里学生机的操作系统恰恰都是Windows 2000，教师机的操作系统是Windows XP。这下有办法了，我们就用“任务管理器”中设置优先级的功能解决前面的问题。

 以Windows XP为例，首先打开“任务管理器”。在“应用程序”选项页中找到正在运行的[Word](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/10/01/1911.shtml)、Excel或其他应用程序，单击鼠标右键选择“转到[进程](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/9/01/1854.shtml)”。当然，也可以直接在“进程”选项页中找到正在运行的应用程序，并单击鼠标右键选择“设置优先级”（见附图），设置为“高于标准”。再用同样的方法找到KV2004杀毒软件的“优先级”，将其设置为“低于标准”即可。设置完成之后，再运行软件时，Word、Excel等应用软件就会先运行，然后再运行KV2004。经测试，打开文档[速度](http://school.enet.com.cn/eschool/includes/zhuanti/shuyu/info/2/09/217.shtml)果然加快了。
